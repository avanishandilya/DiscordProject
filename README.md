...
As time goes on, the average number of messages per year keep decreasing. One reason for this is that since social distancing was decreasing, people met up more and did not find the need to text as much. Additionally, this Discord server was made while most members were in high school. Research shows that friends tend to grow apart in college due to a physical separation, academic work, and new friendships (Source 4). As college goes on, the members are phsically separated for most of the year. As a result of the separation and the academic work, members might find it harder to find time to stay connected to each other during college. 
